...
import { formatHtml, minifyHtml } from "@/src/logic/html-formatter-minifier";

export function HtmlFormatterMinifierTool() {
  ...
  const handleFormat = () => {
    setError("");
    try {
      const res = formatHtml(htmlInput, indentSize);
      setResult(res);
    } catch (e) {
      setError(e instanceof Error ? e.message : "Error formatting HTML");
      setResult("");
    }
  };
  ...
  const handleMinify = () => {
    setError("");
    try {
      const res = minifyHtml(htmlInput);
      setResult(res);
    } catch (e) {
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder='e.g.&#10;<div class="hero"><h1>Welcome to Toolkit</h1><p>Offline & secure</p></div>'
          value={htmlInput}

...
### Existing Tools
- [x] Age Calculator (`age-calculator`) - **Done** ✅
- [x] BMI Calculator (`bmi-calculator`) - **Done** ✅
- [x] Percentage Calculator (`percentage-calculator`) - **Done** ✅
- [x] JSON Formatter / Validator (`json-formatter`) - **Done** ✅
- [x] UUID Generator (`uuid-generator`) - **Done** ✅
- [x] Base64 Encoder / Decoder (`base64-encoder-decoder`) - **Done** ✅
- [x] Hash Generator (`hash-generator`) - **Done** ✅
- [x] Word / Character Counter (`word-character-counter`) - **Done** ✅
- [x] Case Converter (`case-converter`) - **Done** ✅
